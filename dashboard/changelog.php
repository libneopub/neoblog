    ...
    <?php if ($_SESSION['login'] === true) { ?>
        ...
        <div class="w3-main module-content">
            ...
            <div class="w3-container">
                ...
                <h3>What's new?</h3>
                <p>
                    <b>v0.04-beta</b> This release of SkyLight introduces comments.<br />It also has a completely rewritten backend UI that is more modular and easier to maintain. It also introduces custom menus for theme development and has a new feature called Quickstart on the dashboard.
                    <hr>
                    <b>v0.03.1-beta</b> This patch fixes some grammar mistakes in the UI and reorganizes the settings panel.<br>I also added an option to add custom CSS styling trought the settings panel (if the theme supports it).<br>It is recommended to download the optional CSS updates from the settings panel to prevent visual bugs in the editor.
                    <hr>
                    ...
                    I also finally implemented the theme library.<br>And there's now an easy way to backup userdata.<br>
                    <hr>
                    <b>v0.02.1-beta</b> This patch fixes the bug that could cause code-injection, <br>
                    and passwords are now hashed, and not stored as plain text.<br>
                    <hr>
